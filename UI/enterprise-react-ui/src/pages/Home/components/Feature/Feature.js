...
function Feature() {
    return (
        ...
        //         <p className="text">
        //             “Students at the University of Greenwich will not only focus
        //             on the key theoretical and practical aspects of their
        //             studies but they will also develop a range of those general
        //             skills that are essential in any career.
        //         </p>
        //         <p className="text">
        //             The ability to communicate well, to think critically, to
        //             work in a team and to solve problems are all characteristics
        //             of Greenwich students. These skills are increasingly in
        //             demand from employers. “
        //         </p>
        //         <p className="author">
        //             Professor Jane Harrington, Vice - Chancellor of the
        //             University of Greenwich, UK
        //         </p>
        //     </div>
        //     <div className="image col">
        //         <img
        //             src="https://media.discordapp.net/attachments/984158010731548722/1213913753238896650/image.png?ex=65f73448&is=65e4bf48&hm=151c3b4ae868550a49848fc0d31fce2a549574746ad3de2692b23d094df6f52c&=&format=webp&quality=lossless&width=263&height=350"
        //             alt=""
        //         />
