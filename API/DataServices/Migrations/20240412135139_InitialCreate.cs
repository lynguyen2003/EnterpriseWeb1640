        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contributions_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "6a98f26f-699e-461f-857c-36ed1c679653", null, "Student", "STUDENT" },
                    { "961f424e-9a22-4653-ba72-603c9a2bfaf1", null, "Guest", "GUEST" },
                    { "bb0fe9e1-ff03-4ac0-b81b-4674c5904404", null, "MarketingManager", "MARKETINGMANAGER" },
                    { "c9f2cfe5-89ce-4f54-bb3c-2dc01528d8dd", null, "Admin", "ADMIN" },
                    { "fcd0d850-67ea-4dd7-959e-164f952fc743", null, "MarketingCoordinator", "MARKETINGCOORDINATOR" }
                });

            migrationBuilder.InsertData(
                table: "ClosureDates",
                columns: new[] { "Id", "AcademicYear", "ClosureDate", "FinalClosureDate", "IsSet" },
                values: new object[] { 1, "2022/2025", new DateTime(2024, 4, 25, 11, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false });
